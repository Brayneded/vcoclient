...
class VcoClient:
    ...
    def get_enterprise_edges(self, enterprise_id: int = 0) -> object:
        if enterprise_id == 0:
            body = {}
        else:
    ...
    def get_edge_link_series(self, enterprise_id: int, edge_id: int, **kwargs) -> object:
        """
    ...
    def get_identifiable_applications(self, enterprise_id):
        ...
        return resp.json()
            ...
            # Collects a list of identifiable apps from the VCO
    def get_edge_configuration_stack(self, enterprise_id: int, edge_id: int):
        resp = self.request('configuration/getIdentifiableApplications',
